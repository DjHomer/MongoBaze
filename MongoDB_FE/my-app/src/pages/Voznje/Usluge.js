            ...
            {usluge.map(el=>{
                ...
                <div  className="float-containerforma" style={{textAlign:"center"}}>
                    <div className="float-child" style={{width:"30%"}}>
                        <p style={{color:"#FFFFFF"}}> {el.naziv}</p><br/>
                    </div>
                    ...
                    <div className="float-child" style={{width:"30%"}}>
                        <p style={{color:"#FFFFFF"}}>Cena: {el.cena} din.</p><br/>
                    </div>
                </div>);
            })}
            <div className="float-child" style={{width:"100%"}}>
            <button style={{backgroundColor:"#4e9af1", color:"#FFFFFF", fontSize: 20, cursor:"pointer"}} type="button" onClick={()=>DodajUslugeRezervaciji()}>Potvrdi</button> </div>
        </div>
